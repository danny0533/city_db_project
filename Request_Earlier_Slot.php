...
<html>
	...
	<body>
		...
		<div>
			    <h2>Request Earlier Departure slot</h2>
	...
	<?php 
		...
		if ($sqlResult->num_rows > 0) {	
				...
				if ($sqlLogResult->num_rows <= 0) {
					...
					VALUES (0, ".$schID.", ".$schID.", CURDATE(), 'Exchanging Earlier Slot', 0)";
					//echo $insertSQL;
				...
				// 		$sql = "UPDATE $schema.tb_exchange_slot_log SET STATUS ='Exchanging' WHERE ORI_SCH_ID=".$schID.";";
	    ...
	    <br/>
	   	<?php 
	   		if($hasRecord){
                ...
                <input type="hidden" name="hd_RequestType" value="<?php echo 'EARLIER' ?>">
